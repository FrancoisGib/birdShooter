import akImgSrc from '../assets/images/ak.png';
import GameElement from "./gameElement.js";

/** The class that defines a Bow in the game */
export default class Ak extends GameElement {
    static WIDTH = 25; /* The widh of the bow's image */
    static HEIGHT = 90; /* The height of the bow's image */
    ...
    move(canvas, i, j) {
        ...
        if (newX + Ak.WIDTH <= canvas.width && newX >= 0) {
            this.x = newX;
        }
        if (newY + Ak.HEIGHT <= canvas.height && newY >= 100) {
            this.y = newY;
        }
    }
}
